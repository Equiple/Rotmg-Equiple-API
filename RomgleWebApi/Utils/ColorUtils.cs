...
namespace RomgleWebApi.Utils
{
    public static class ColorUtils
    {
        ...
        public readonly static List<Color> rainbowSmall = new List<Color>(new Color[]
        {
        ...
        public readonly static List<Color> differenceGradientRGBsmall = new List<Color>(){
        ...
        public readonly static List<Color> differenceGradientRGB = new List<Color>(){
            ColorTranslator.FromHtml("#339900"),
        ...
        public readonly static List<Color> differenceGradientLAB = new List<Color>(){
            ColorTranslator.FromHtml("#339900"),
        ...
        {
            List<Color> newGradient = new List<Color>();
            newGradient.Add(gradient[0]);
            newGradient.Add(gradient[(gradient.Count / 2) - ((gradient.Count / 2) / 2)]);
            newGradient.Add(gradient[gradient.Count / 2]);
            newGradient.Add(gradient[gradient.Count - ((gradient.Count / 2) / 2)]);
            newGradient.Add(gradient[gradient.Count - 1]);
            return newGradient;
        }
    }
}
